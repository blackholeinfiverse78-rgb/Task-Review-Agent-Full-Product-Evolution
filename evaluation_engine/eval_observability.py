"""
Parikshak Operational Governance — Evaluation Observability
============================================================
Structured operational log emitter for the evaluation layer.
No silent failures. Every event is logged explicitly.

Severity mapping:
  - Contract violations → CRITICAL
  - Graph rejects       → ERROR
  - Submission/eval     → INFO
"""
...
class ObservabilityEmitter:
    ...
    def emit_contract_violation(self, trace_id: str, violation: str) -> ObservabilityEvent:
