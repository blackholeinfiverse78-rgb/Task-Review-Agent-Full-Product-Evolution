...
2. **High-Throughput Concurrency**: Even with 100 concurrent requests, the average request latency stays below **1.5 ms**, with a system throughput of **8906 requests/sec**.
